...
def materialize(df, con):
    ...
    tmp_name = '__dbt_python_model_df_' + 'raw__indices_of_deprivation__dbt_tmp'
    con.register(tmp_name, df)
    con.execute('create table "WMCSRP2"."md_raw"."raw__indices_of_deprivation__dbt_tmp" as select * from ' + tmp_name)
