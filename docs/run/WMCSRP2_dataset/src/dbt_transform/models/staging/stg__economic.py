...
class this:
    ...
    def __repr__(self):
        return '"WMCSRP2"."main_staging"."stg__economic"'
...
def materialize(df, con):
    ...
    tmp_name = '__dbt_python_model_df_' + 'stg__economic__dbt_tmp'
    con.register(tmp_name, df)
    con.execute('create table "WMCSRP2"."main_staging"."stg__economic__dbt_tmp" as select * from ' + tmp_name)
