...
class this:
    ...
    database = "WMCSRP2"
    schema = "main_staging"
    identifier = "stg__wellbeing"
    
    def __repr__(self):
        return '"WMCSRP2"."main_staging"."stg__wellbeing"'
...
def materialize(df, con):
    ...
    tmp_name = '__dbt_python_model_df_' + 'stg__wellbeing__dbt_tmp'
    con.register(tmp_name, df)
    con.execute('create table "WMCSRP2"."main_staging"."stg__wellbeing__dbt_tmp" as select * from ' + tmp_name)
