...
class this:
    ...
    database = "WMCSRP2"
    schema = "main_staging"
    identifier = "stg__census"
    
    def __repr__(self):
        return '"WMCSRP2"."main_staging"."stg__census"'
...
def materialize(df, con):
    ...
    tmp_name = '__dbt_python_model_df_' + 'stg__census__dbt_tmp'
    con.register(tmp_name, df)
    con.execute('create table "WMCSRP2"."main_staging"."stg__census__dbt_tmp" as select * from ' + tmp_name)
